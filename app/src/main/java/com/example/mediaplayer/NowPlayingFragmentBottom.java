...
import static com.example.mediaplayer.MainActivity.ARTIST_TO_FRAG;
...
import static com.example.mediaplayer.MusicService.MUSIC_FILE;
import static com.example.mediaplayer.MusicService.MUSIC_LAST_PLAYED;
                        ...
                        if(SHOW_MINI_PLAYER){
                            if(PATH_TO_FRAG!=null) {
                                ...
                                if(art!=null){
                                    ...
                                    Glide.with(getContext()).load(R.drawable.sponge).into(albumArt);
                                }
